...
int test_write(const char *str) {
  ...
  printf("Write %ld byte in stdout with write\n", standart_result);  
  // printf("Write %ld byte in stdout with ft_write\n", my_result);

  // result = ft_write(1, str, str_len);  
  // printf("\nTest: %s\n", "write in file");
